...
//     const style = type === "header" ? "text-[64px]" : "text-[32]";
//     const imgSize = type === "header" ? 77 : 40;

//     return (
//         <div className="flex min-w-fit items-center">
//             <p className={`font-arima font-bold text-primary-200 text-4xl lg:${style} uppercase`}>w</p>
//             <img src= {logo} 
//                 alt="logo"
//                 width={imgSize}
//                 height={imgSize}
//             />
//             <p className={`font-arima font-bold text-primary-200 text-4xl lg:${style} uppercase`}>lkway</p>
//         </div>
//     );
// }
